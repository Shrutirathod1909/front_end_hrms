...
const CompanyPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // =========================
        ...
        await axios.put(
          `${API_URL}/api/companies/${isEditing.id}`,
          data,
          config,
        );
  ...
  const handleDelete = async (id) => {
    if (window.confirm("Are you sure you want to delete this company?")) {
      try {
        await axios.delete(`${API_URL}/api/companies/${id}`, getAuthHeaders());
  ...
  const handleDownloadExcel = async () => {
    try {
      ...
      const response = await axios.get(`${API_URL}/api/companies/export`, {
        params,
        responseType: "blob",
        ...getAuthHeaders(),
      });
                      ...
                      <tr key={idx}>
                        ...
                        <td>
                          <Form.Select
                            ...
                            onChange={(e) => handleBankChange(idx, e)}
                            isInvalid={!!validationErrors[`accountType_${idx}`]}
                          >
                        ...
                        <td>
                          <Form.Control
                            ...
                            onChange={(e) => handleBankChange(idx, e)}
                            isInvalid={!!validationErrors[`branchCity_${idx}`]}
                          />
                          <Form.Control.Feedback type="invalid">
